...
{
    fields  => [ qw/id name description startdate enddate isactive price/],
    ...
    checks  => [ [qw/name startdate enddate isactive price/] => is_required("T&auml;yt&auml; kaikki pakolliset kent&auml;t!"),
                 startdate => sub {
                                       my ($value, $params) = @_;
